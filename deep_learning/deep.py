...
optimizer = torch.optim.Adam([{'params':model_1[0].parameters()}, {'params':model_1[1].parameters()}, {'params':model_1[2].parameters()}, {'params':model_1[3].parameters()}, {'params':model_1[4].parameters()}, {'params':model_1[5].parameters()}, {'params':model_1[6].parameters()}, {'params':model_1[7].parameters()}, {'params':model_2.parameters()}], lr=0.0001)



#traing and testing
def train(model_1, model_2, input_train, train_label, input_test, test_label, batch_size, optimizer, criterion, epochs = 8):
