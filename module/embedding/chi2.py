...
if __name__ == '__main__':
    for f in input_data:
        ...
        for l in label:
            ...
            df = pd.read_csv('C:/Users/65905/Desktop/djangoProject/data/raw_data/mebe_tiki.csv', encoding='utf-8')
            # df = df[df[l] != 0]
            ...
            df.to_csv('output/label_{}'.format(l) + '_{}'.format(name + str(f.split('/')[2])), ',', encoding='utf-8')
